"""TypePoutre : Solive — flexion mono-axe, charges horizontales, pente nulle.
...
class Solive(TypePoutre):
    """Solive de plancher — chargement vertical, mono-axe.

    Pente supposée nulle. Pas de double flexion.
    """
    ...
    def decomposer(
        ...
        """Solive : pas de décomposition — tout en axe fort."""
