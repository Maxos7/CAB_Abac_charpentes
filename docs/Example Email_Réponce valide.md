...
Pour les données suivante fournie dans le formulaire :
...
Pour toutes questions, nous reston a votre disposition en retoure de cet e-mail.
Cordialement,
L'equipe du bureau d'étude charpente,